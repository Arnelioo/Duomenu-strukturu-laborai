...
//        if(element == null)
//        throw new IllegalArgumentException("Nulinis elementas");
...
//        if(n == null)
//        return n;
//        int compareRes = element.compareTo(n.element);
//        if(compareRes < 0)
...
//        {
//            n.element = rastiMin(n.right);
//        }
//    }
    
    private AVLNode<E> rastiMin( AVLNode<E> n )
{
    if( n == null )
        return n;
