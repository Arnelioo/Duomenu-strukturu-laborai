 ...
 */
public final class Filmas implements KTUable {
   ...
   /**
    ...
    public String toString() {
        return filmoPav + "_" + žanras + "_" + studija + "_" + režisierius + ":" + išleidimoMetai + " " + String.format("%4.1f", pelnas) ;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(filmoPav, žanras, studija, režisierius, pelnas, išleidimoMetai);
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Filmas other = (Filmas) obj;
        if (!Objects.equals(this.filmoPav, other.filmoPav)) {
            return false;
        }
        if (!Objects.equals(this.žanras, other.žanras)) {
            return false;
        }
        if (!Objects.equals(this.studija, other.studija)) {
            return false;
        }
        if (!Objects.equals(this.režisierius, other.režisierius)) {
            return false;
        }
        if (this.išleidimoMetai != other.išleidimoMetai) {
            return false;
        }
        if (Double.doubleToLongBits(this.pelnas) != Double.doubleToLongBits(other.pelnas)) {
            return false;
        }
